...
class about
{
    public function execute($id)
    {
        $description_1 = '
            <p>
                <strong>
                    ক্যালভিন ক্লেইনের প্রিমিয়াম পাঞ্জাবি, যা ঐতিহ্য এবং আধুনিকতার সমন্বয়ে তৈরি। এই পাঞ্জাবিগুলো বিভিন্ন রঙে পাওয়া যায়, যেমন সাদা, কালো, নীল, মেরুন, এবং সবুজ। আপনার ব্যক্তিগত পছন্দ অনুযায়ী পাঞ্জাবি বেছে নেওয়ার অনেক অপশন রয়েছে।
                </strong>
            </p>
            <h3><strong>ডিজাইন এবং বৈশিষ্ট্য:</strong></h3>
            <p>
                এই পাঞ্জাবিগুলো <strong>পরিষ্কার এবং মিনিমাল ডিজাইন</strong> দিয়ে তৈরি, যা যেকোনো অনুষ্ঠানে মানানসই। প্রতিটি পাঞ্জাবিতে রয়েছে <strong>সূক্ষ্ম এমব্রয়ডারি</strong>, স্টাইলিশ কলার, এবং আরামদায়ক ফ্যাব্রিক, যা দীর্ঘ সময় ধরে পরার জন্য আদর্শ। পাঞ্জাবিগুলো হালকা কিন্তু মজবুত, যা গরম এবং ঠান্ডা উভয় আবহাওয়ার জন্য উপযুক্ত।
            </p>
            <h3><strong>সাইজ মাপ:</strong></h3>
            <p>
                গ্রাহকদের সঠিক সাইজ বাছাই করতে একটি <strong>বিস্তারিত সাইজ চার্ট</strong> দেওয়া হয়েছে। চার্টে <strong>বুক, লম্বা এবং হাতার দৈর্ঘ্য</strong> ইনচে উল্লেখ করা হয়েছে:
            </p>
            <figure class="table">
            <table>
                <thead>
            ...
            <p>
                এই উপস্থাপনায় <strong>ঐতিহ্য, আরাম এবং আধুনিক স্টাইল</strong>-এর সমন্বয় তুলে ধরা হয়েছে, যা ক্যালভিন ক্লেইনের পাঞ্জাবিকে যেকোনো অনুষ্ঠানের জন্য অবশ্যই কেনার একটি পণ্য হিসেবে উপস্থাপন করে।
            </p>
        ';
